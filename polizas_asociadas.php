            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    ...
                    if ($baja == 1) { ?>
                        ...
                        <td><a class="btn btn-primary ml-3" href="pagos?id=<?php echo $row['id'] ?>&cliente=<?PHP echo intval($_GET['id']) ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
