            ...
            <?php if ($result->num_rows > 0): ?>
                ...
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="perfil_poliza?id=<?php echo  $row['id_seguro'] ?>&id_cliente=<?php echo $id  ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
